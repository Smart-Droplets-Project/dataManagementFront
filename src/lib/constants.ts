...
// TODO: These 2 localhost values need to be exchanged to "oauth2-proxy:4180"
export const ENDPOINTS = {
    // API_BASE_URL: process.env.NEXT_PUBLIC_API_BASE_URL || `http://localhost:1026/${NGSI_ENTITY_QUERY_PATH}`,
    API_BASE_URL: process.env.ORION_CB_BASE_URL ? `${process.env.ORION_CB_BASE_URL}/${NGSI_ENTITY_QUERY_PATH}` : `http://localhost:1026/${NGSI_ENTITY_QUERY_PATH}`,
